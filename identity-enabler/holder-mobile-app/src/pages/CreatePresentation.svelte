<script lang="ts">
    ...
    import { error, IdentityService, ServiceFactory, Button, FullScreenLoader } from "@zebra-iota-edge-sdk/common/dist";
    ...
    function goBack() {
        router.replace("/credential", { credential: credential });
    }
